      ...
      <section className="bg-zinc-950 py-24 border-b-4 border-primary relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-8">
          ...
          <motion.p initial="hidden" animate="visible" variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6, delay: 0.1 } } }} className="text-xl text-zinc-400 max-w-2xl leading-relaxed">
            Established in {companyInfo.established}, Nandi Power Controls and Systems is an ISO 9001:2015 certified manufacturer known for engineering excellence, dependable service, and uncompromising quality.
          </motion.p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            >
              ...
              <div className="prose prose-zinc max-w-none text-zinc-600 leading-relaxed text-lg space-y-6">
                <p>
                  Since our inception in 2010, NANDI POWER CONTROLS AND SYSTEMS has grown to become a cornerstone of reliability in the industrial power sector. Based in Bengaluru, we specialize in the design, manufacturing, and supply of Power Distribution Transformers ranging from 5kVA to 5000kVA.
                </p>
                <p>
                  As an ISO 9001:2015 certified company, we don't just build transformers; we engineer solutions that power critical infrastructure. Our commitment to quality is validated by stringent CPRI testing and strict adherence to IS and IEC standards.
                </p>
                <p>
                  Beyond transformers, our capabilities extend to Special Purpose Machines (SPMs) and heavy-duty fabrication, allowing us to serve as a comprehensive manufacturing partner for our demanding B2B clients across diverse industries.
                </p>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-zinc-600 text-lg">
              From design transparency to stage inspections, our manufacturing pipeline is built for total reliability.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-3">Transparent Design</h4>
              <p className="text-zinc-600">
                Full transparency with customer participation in design reviews. Standard designs up to 500kVA are fully type-tested.
              </p>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-3">Precision Fabrication</h4>
              <p className="text-zinc-600">
                Tank fabrication from tested mild steel with leak testing at 0.5 kg/cm² or higher, paired with pressed steel radiators.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-600">
                Our reputation is built on timely delivery and dependable post-installation service across industrial sectors.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-zinc-400 text-lg">
              Our products are engineered in strict accordance with IS:2026, IS:1180, IEC:76, and BS:171 standards.
            </p>
          </div>
