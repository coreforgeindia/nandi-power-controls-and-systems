              ...
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div className="h-52 overflow-hidden relative">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-[#0B3C5D] shadow-sm flex items-center gap-1.5 border border-zinc-200/50">
