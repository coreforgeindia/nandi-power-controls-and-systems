      ...
      <section className="py-24">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            {/* Contact Info */}
            <div>
              <h2 className="text-3xl font-bold mb-8">Let's Discuss Your Power Needs</h2>
              <p className="text-zinc-600 mb-10 text-lg leading-relaxed">
                Whether you need a standard distribution transformer or a custom SPM solution, our engineering team is ready to assist you.
              </p>
              ...
              {isSubmitted ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-12">
                  ...
                  <p className="text-zinc-600 mb-8 max-w-md">
                    Thank you for reaching out to Nandi Power. Our engineering sales team will review your requirements and contact you shortly.
                  </p>
                  <Button 
                    variant="outline" 
                    onClick={() => {
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                <SelectItem value="distribution">Power Distribution Transformers</SelectItem>
                                <SelectItem value="dry">Dry Type Transformers</SelectItem>
                                <SelectItem value="special">Special Type Transformers</SelectItem>
                                <SelectItem value="spm">SPMs / Heavy Fabrication</SelectItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea 
                                placeholder="Please describe your capacity requirements, voltage class, or fabrication needs..." 
