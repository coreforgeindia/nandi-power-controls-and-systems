...
export default function Home() {
  ...
  const clientLogos = [
    { name: "ABB", type: "Partner" },
    { name: "Siemens", type: "Supplier" },
    { name: "Schneider", type: "Associate" },
    { name: "L&T", type: "Vendor" },
    { name: "Havells", type: "Provider" },
    { name: "Legrand", type: "Partner" }
  ];

  const previewGallery = [
    { url: coreConstructionImg, caption: "Core Construction" },
    { url: tankFabricationImg, caption: "Tank Fabrication" },
    { url: terminationsImg, caption: "Terminations & Bushings" }
  ];
    ...
    <div className="flex flex-col w-full bg-white font-sans">
      ...
      >
        ...
        <div className="max-w-[1280px] w-full relative z-10 px-4 md:px-8 mx-auto">
          ...
          >
            ...
            >
              NANDI POWER <br />
              <span className="text-primary text-3xl sm:text-4xl md:text-5xl">CONTROLS AND SYSTEMS</span>
            </motion.h1>
            ...
            >
              Delivering Reliable Electrical Control Panels, Automation Solutions, and Industrial Power Systems with Quality, Innovation, and Precision.
            </motion.p>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2 space-y-6">
              <span className="text-primary font-bold text-sm uppercase tracking-wider">Engineering Trust Since 2010</span>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D]">Who We Are</h2>
              <div className="h-1 w-20 bg-primary"></div>
              <p className="text-zinc-600 text-lg leading-relaxed">
                NANDI POWER CONTROLS AND SYSTEMS is a premier, B2B-focused manufacturer and engineering services company. Based in Bengaluru, we specialize in high-reliability Power Distribution Transformers (5kVA to 5000kVA), Special Purpose Machines, and heavy-duty structural steel fabrication.
              </p>
              <p className="text-zinc-500 leading-relaxed text-sm">
                Certified per ISO 9001:2015, we operate with maximum transparency, allowing stage-wise inspections. Our standard transformer models have successfully passed CPRI type tests for impulse, short circuit, and temperature rise durability.
              </p>
              <div className="pt-4">
                <Link href="/about">
                  <Button className="bg-[#0B3C5D] hover:bg-[#0B3C5D]/90 text-white font-bold h-12 px-6 rounded-xl">
            ...
            <div className="lg:w-1/2 bg-zinc-50 p-8 rounded-3xl border border-zinc-100 flex flex-col justify-center space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-navy text-lg mb-1">ISO 9001:2015 Certified</h4>
                  <p className="text-zinc-600 text-sm">Standardized manufacturing processes ensuring consistent, reliable products.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary flex-shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-navy text-lg mb-1">State-of-the-Art Facility</h4>
                  <p className="text-zinc-600 text-sm">Modern sheet metal and winding machinery ensuring precise tolerances.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-zinc-50 border-y border-zinc-150">
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D] mt-2 mb-4">Why Choose Nandhi Power</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-zinc-100 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-navy">Quality & Compliance</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Conforming strictly to IS:2026, IS:1180, and CPRI testing standards. We use high-conductivity CRGO laminations and premium paper-insulated copper.
                </p>
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-zinc-100 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-navy">Consultative Customization</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  We allow clients to participate in initial design iterations and stage-wise inspections. Your specifications dictate the final unit footprint.
                </p>
              </div>
              <Link href="/why-us" className="block mt-6">
                <span className="text-primary text-xs font-bold hover:underline cursor-pointer flex items-center gap-1">
            ...
            <div className="bg-white p-8 rounded-2xl border border-zinc-100 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-navy">Dedicated B2B Support</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  From testing to dispatch and on-site support, our engineers provide complete backup service, ensuring minimal downtime for your machinery.
                </p>
              </div>
              <Link href="/why-us" className="block mt-6">
                <span className="text-primary text-xs font-bold hover:underline cursor-pointer flex items-center gap-1">
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-16">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D] mt-2 mb-4">Featured Solutions</h2>
              <div className="h-1 w-20 bg-primary"></div>
            </div>
            <Link href="/products">
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-16">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D] mt-2 mb-4">Industries We Serve</h2>
              <div className="h-1 w-20 bg-primary"></div>
            </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-16">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D] mt-2 mb-4">Featured Projects</h2>
              <div className="h-1 w-20 bg-primary"></div>
            </div>
            <Link href="/projects">
              <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-white font-bold rounded-xl h-12 mt-4 sm:mt-0">
      ...
      <section className="py-16 bg-zinc-50 border-b border-zinc-150">
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <p className="text-center text-zinc-400 font-bold text-xs uppercase tracking-widest mb-10">
            Trusted by Engineering Partners & Supply Networks
          </p>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-16">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D] mt-2 mb-4">Facility & Assembly Gallery</h2>
              <div className="h-1 w-20 bg-primary"></div>
            </div>
            <Link href="/gallery">
              <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-white font-bold rounded-xl h-12 mt-4 sm:mt-0">
      ...
      <section className="py-24 bg-zinc-50 border-y border-zinc-150">
        <div className="max-w-[1280px] mx-auto px-4 md:px-8 max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B3C5D] mt-2 mb-4">Frequently Asked Questions</h2>
      ...
      <section className="py-24 bg-white text-center relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto px-4 relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-navy">Ready to Power Your Infrastructure?</h2>
          <p className="text-zinc-500 text-xl mb-10 max-w-2xl mx-auto">
            Contact our engineering team to discuss your specific electrical distribution and manufacturing requirements.
          </p>
